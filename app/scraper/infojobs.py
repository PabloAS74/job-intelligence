        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                for link in job_links:
                    ...
                    company_element = container.find(
                        attrs={
                            "data-testid":
                            lambda value:
                            value
                            and "company" in value.lower()
                        }
                ...
                print(
                    f"✅ ¡Se han encontrado "
                    f"{len(jobs_found)} ofertas!"
                )

            except Exception as e:

                print(
                    f"❌ Error durante el scraping: {e}"
                )
